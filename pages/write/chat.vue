<template>
	<view style="height: 100%" @click="hideCopyBtn">
		<view class="page">
			<scroll-view v-if="lists && lists.length > 0" class="box-msg-list" :scroll-x="false" :scroll-y="true" :scroll-with-animation="false" :scroll-top="scrollTop" :style="'bottom: ' + (inputShow ? '316rpx' : '102rpx') + ';'">
				<view class="list">
			...
			<scroll-view v-else class="box-msg-list" :scroll-x="false" :scroll-y="true" :scroll-with-animation="false" :style="'background: #f7f7f8; bottom: ' + (inputShow ? '316rpx' : '102rpx') + ';'">
				<welcome
					module="write"
					:title="welcomeTitle"
					:desc="welcomeDesc"
